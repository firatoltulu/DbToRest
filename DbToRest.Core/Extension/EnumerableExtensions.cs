...
namespace DbToRest.Core
{
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<T> Diff<T>(this IEnumerable<T> source, IEnumerable<T> diff)
        {
            Guard.ArgumentNotNull<IEnumerable<T>>(() => source);
            Guard.ArgumentNotNull<IEnumerable<T>>(() => diff);

            return source.Except(diff);
        }
