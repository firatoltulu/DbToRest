...
namespace DbToRest.Core
{
    ...
    public interface ILogService
    {
        ...
        void LogException(LogLevel level, [Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Trace([Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Debug([Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Info([Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Warn([Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Error([Localizable(false)] string message, System.Exception exception);
        ...
        /// <param name="message">A <see langword="string" /> to be written.</param>
        /// <param name="exception">An exception to be logged.</param>
        void Fatal([Localizable(false)] string message, System.Exception exception);
