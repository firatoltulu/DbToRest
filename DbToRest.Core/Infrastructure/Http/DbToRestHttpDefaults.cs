...
namespace DbToRest.Core.Infrastructure.Http
{
    /// <summary>
    /// Represents default values related to HTTP features
    /// </summary>
    public static partial class DbToRestHttpDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static string IsPostBeingDoneRequestItem => "DbToRest.IsPOSTBeingDone";
