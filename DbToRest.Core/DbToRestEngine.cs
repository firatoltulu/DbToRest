...
namespace DbToRest.Core
{
    ...
    /// </summary>
    public class DbToRestEngine : IEngine
    {
        #region Properties
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    var parameters = constructor.GetParameters().Select(parameter =>
                    {
                        ...
                        if (service == null)
                            throw new DbToRestException("Unknown dependency");
                        return service;
                    });
            ...
            throw new DbToRestException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
